# Generated by Django 4.2 on 2023-10-19 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='database.comments')),
            ],
        ),
        migrations.CreateModel(
            name='members',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_films', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.films')),
                ('id_genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.genre')),
            ],
        ),
        migrations.CreateModel(
            name='favorites',
